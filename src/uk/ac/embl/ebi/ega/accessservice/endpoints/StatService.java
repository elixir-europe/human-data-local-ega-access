    ...
    public JSONObject handle(ArrayList<String> id, Map<String, String> parameters, FullHttpRequest request, SigVer sig, EgaSecureAccessService ref) {
        ...
        try {
            ...
            if (function.equalsIgnoreCase("load")) { // CPU Load
                result = new String[]{String.valueOf(EgaSecureAccessService.getSystemCpuLoad())};
            ...
            } else if (function.equalsIgnoreCase("ip")) {
                String ip = parameters.containsKey("ip")?parameters.get("ip"):"N/A";
